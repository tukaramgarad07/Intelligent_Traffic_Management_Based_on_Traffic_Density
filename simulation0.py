...
'''
# Assuming there is a signals list with signal objects and other required variables

# Function to handle button click
def handleButtonClick():
    global currentGreen, currentYellow, nextGreen, will_turn
    """# Close all signals
...
speeds = {'car':2.25, 'bus':1.8, 'truck':1.8, 'rickshaw':2, 'bike':2.5, 'ambulance': 3.5, 'police_van': 2.9, 'fire_bridage': 2.7}  # average speeds of vehicles
...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        global totalVehicles1,totalVehicles2,totalVehicles3,totalVehicles4
...
class Main:
   ...
   # screen.blit(background, (0, 0))
    ...
    buttonText = font.render("Emergency Vechicle", True, white, (0, 128, 255))
 #   screen.blit(buttonText, (buttonCoods[0] + 10, buttonCoods[1] + 5))
    ...
    while True:
        ...
        # Assuming you have a variable to store the crossed vehicle count
        
        # Assuming you have a list to store the crossed vehicle count for each signal
        ...
        # Now you can use the "crossed_vehicle_counts" list to access the total crossed vehicle count for each signal.
        # For example, you can print it, use it in calculations, etc.
         # display vehicle count for each lane
        totalVehicleText = font.render("Lane1 Vehicles: {}".format(totalVehicles1-crossed_vehicle_counts[0]), True, white, black)
        screen.blit(totalVehicleText, (10, 240))
        totalVehicleText = font.render("Lane2 Vehicles: {}".format(totalVehicles2-crossed_vehicle_counts[1]), True, white, black)
        screen.blit(totalVehicleText, (810, 20))
        totalVehicleText = font.render("Lane3 Vehicles: {}".format(totalVehicles3-crossed_vehicle_counts[2]), True, white, black)
        screen.blit(totalVehicleText, (1210, 580))
        totalVehicleText = font.render("Lane4 Vehicles: {}".format(totalVehicles4-crossed_vehicle_counts[3]), True, white, black)
